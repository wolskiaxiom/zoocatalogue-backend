...
insert into animals(id,animal,name,price,image_url,in_stock,fast_delivery,ratings) values (4,'Japanese Spitz','Incredible Cotton Mouse',470.00,'https://japanesedogbreedguide.com/wp-content/uploads/2020/02/Japanese-Spitz-Breed-1024x576.png',1,'true',3);
...
insert into animals(id,animal,name,price,image_url,in_stock,fast_delivery,ratings) values (18,'Shih Tzu','Unbranded Frozen Cheese',1800.00,'https://www.purina.pl/sites/default/files/styles/nppe_breed_selector_500/public/breed_library/shih_tzu.jpg?itok=qZ7j0JSt',0,'true',4);
